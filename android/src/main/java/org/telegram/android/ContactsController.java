...
public class ContactsController {
  ...
  public void checkInviteText() {
    ...
    if (!updatingInviteText
        && (inviteText == null || time + 86400 < (int) (System.currentTimeMillis() / 1000))) {
                      ...
                      AndroidUtilities.runOnUIThread(
                          new Runnable() {
                            ...
                            public void run() {
                              ...
                              editor.putInt(
                                  "invitetexttime", (int) (System.currentTimeMillis() / 1000));
                              editor.commit();
                            }
                          });
                    }
          ...
          public void run() {
            if (checkContactsInternal()) {
              ...
              ContactsController.getInstance()
                  .performSyncPhoneBook(
                      ContactsController.getInstance()
                          .getContactsCopy(ContactsController.getInstance().contactsBook),
                      true,
                      false,
                      true);
            }
  ...
  private boolean checkContactsInternal() {
    ...
    try {
      ...
      try {
        ...
        if (lastContactsVersions.length() != 0
            && !lastContactsVersions.equals(newContactsVersion)) {
          reload = true;
        }
  ...
  public void performSyncPhoneBook(
      final HashMap<Integer, Contact> contactHashMap,
      final boolean requ,
      final boolean first,
    ...
    Utilities.globalQueue.postRunnable(
        new Runnable() {
          ...
          public void run() {
            ...
            boolean disableDeletion =
                true; //disable contacts deletion, because phone numbers can't be compared due to different numbers format
            /*if (schedule) {
             try {
             AccountManager am = AccountManager.get(ApplicationLoader.applicationContext);
            ...
            if (request && first) {
              if (UserConfig.importHash != null && UserConfig.importHash.length() != 0
            ...
            if (!contactHashMap.isEmpty()) {
                  ...
                  for (int a = 0; a < value.phones.size(); a++) {
                    ...
                    if (index == -1) {
                      if (request) {
                        ...
                        if (contact != null) {
                          TLRPC.User user =
                              MessagesController.getInstance().getUser(contact.user_id);
                          if (user == null
                              || user.first_name != null && user.first_name.length() != 0
              ...
              if (!first
                  && contactHashMap.isEmpty()
                  && toImport.isEmpty()
                  && oldCount == contactsMap.size()) {
                      ...
                      new Runnable() {
                        ...
                        public void run() {
                          ...
                          if (contactHashMap != null && !contactHashMap.isEmpty()) {
                            try {
                              final HashMap<String, TLRPC.User> contactsPhonesShort =
                                  new HashMap<>();

                              for (TLRPC.TL_contact value : contacts) {
                                TLRPC.User user =
                                    MessagesController.getInstance().getUser(value.user_id);
                                if (user == null
                                    || user.phone == null
                                    || user.phone.length() == 0) {
                                  continue;
                              ...
                              int removed = 0;
                              for (HashMap.Entry<Integer, Contact> entry :
            ...
            if (request) {
              if (!toImport.isEmpty()) {
                ...
                for (int a = 0; a < count; a++) {
                  ...
                  finalToImport.addAll(
                      toImport.subList(a * 500, Math.min((a + 1) * 500, toImport.size())));
                          ...
                          new RPCRequest.RPCRequestDelegate() {
                            ...
                            public void run(TLObject response, TLRPC.TL_error error) {
                              if (error == null) {
                                ...
                                TLRPC.TL_contacts_importedContacts res =
                                    (TLRPC.TL_contacts_importedContacts) response;
                                if (BuildVars.DEBUG_VERSION) {
                                ...
                                MessagesStorage.getInstance()
                                    .putUsersAndChats(res.users, null, true, true);
                                    ...
                                    new Runnable() {
                                      ...
                                      public void run() {
                                        ...
                                        if (!delayedContactsUpdate.isEmpty()
                                            && contactsLoaded
                                            && contactsBookLoaded) {
                                          applyContactsUpdates(
                                              delayedContactsUpdate, null, null, null);
                                          delayedContactsUpdate.clear();
                                        }
                                      }
                                    });
                    ...
                    new Runnable() {
                      ...
                      public void run() {
                        ...
                        NotificationCenter.getInstance()
                            .postNotificationName(NotificationCenter.contactsDidLoaded);
                      }
                    });
              }
            } else {
  ...
  public void processLoadedContacts(
                  ...
                  public void run() {
                    ...
                    for (TLRPC.TL_contact contact : contactsArr) {
                      if (usersDict.get(contact.user_id) == null
                          && contact.user_id != UserConfig.getClientUserId()) {
                        loadContacts(false, true);
                    ...
                    if (from != 1) {
                      ...
                      Collections.sort(
                          contactsArr,
                          new Comparator<TLRPC.TL_contact>() {
                            @Override
                            public int compare(
                                TLRPC.TL_contact tl_contact, TLRPC.TL_contact tl_contact2) {
                    ...
                    final HashMap<String, ArrayList<TLRPC.TL_contact>> sectionsDict =
                        new HashMap<>();
                    ...
                    final HashMap<String, TLRPC.TL_contact> contactsByPhonesDictFinal =
  ...
  private void performWriteContactsToPhoneBookInternal(ArrayList<TLRPC.TL_contact> contactsArray) {
    try {
      Uri rawContactUri =
          ContactsContract.RawContacts.CONTENT_URI
              .buildUpon()
              .appendQueryParameter(ContactsContract.RawContacts.ACCOUNT_NAME, currentAccount.name)
              .appendQueryParameter(ContactsContract.RawContacts.ACCOUNT_TYPE, currentAccount.type)
              .build();
      Cursor c1 =
          ApplicationLoader.applicationContext
              ...
              .query(
                  rawContactUri,
                  new String[] {BaseColumns._ID, ContactsContract.RawContacts.SYNC2},
                  null,
                  null,
                  null);
  ...
  private void applyContactsUpdates(
      ArrayList<Integer> ids,
      ConcurrentHashMap<Integer, TLRPC.User> userDict,
      ArrayList<TLRPC.TL_contact> newC,
      ArrayList<Integer> contactsTD) {
    ...
    FileLog.e(
        "tmessages",
        "process update - contacts add = " + newC.size() + " delete = " + contactsTD.size());
  ...
  public void processContactsUpdates(
      ArrayList<Integer> ids, ConcurrentHashMap<Integer, TLRPC.User> userDict) {
  ...
  public long addContactToPhoneBook(TLRPC.User user, boolean check) {
        ...
        Uri rawContactUri =
            ContactsContract.RawContacts.CONTENT_URI
                ...
                .appendQueryParameter(
                    ContactsContract.RawContacts.ACCOUNT_NAME, currentAccount.name)
                .appendQueryParameter(
                    ContactsContract.RawContacts.ACCOUNT_TYPE, currentAccount.type)
                .build();
        int value =
            contentResolver.delete(
                rawContactUri, ContactsContract.RawContacts.SYNC2 + " = " + user.id, null);
      } catch (Exception e) {
        FileLog.e("tmessages", e);
      }
    }
    ...
    builder.withValue(
        ContactsContract.Data.MIMETYPE,
        "vnd.android.cursor.item/vndorg.telegram.messenger.android.profile");
  ...
  private void deleteContactFromPhoneBook(int uid) {
    ...
    try {
      ...
      int value =
          contentResolver.delete(
              rawContactUri, ContactsContract.RawContacts.SYNC2 + " = " + uid, null);
    } catch (Exception e) {
      FileLog.e("tmessages", e);
    }
    synchronized (observerLock) {
  ...
  public void addContact(TLRPC.User user) {
    ...
    if (BuildVars.DEBUG_VERSION) {
      FileLog.e(
          "tmessages", "add contact " + user.first_name + " " + user.last_name + " " + user.phone);
    }
    ConnectionsManager.getInstance()
        .performRpc(
            req,
            new RPCRequest.RPCRequestDelegate() {
              ...
              public void run(TLObject response, TLRPC.TL_error error) {
                ...
                final TLRPC.TL_contacts_importedContacts res =
                    (TLRPC.TL_contacts_importedContacts) response;
                        ...
                        public void run() {
                          ...
                          if (!vector.objects.isEmpty()) {
                            ...
                            for (Object object : vector.objects) {
                              ...
                              TLRPC.User user =
                                  MessagesController.getInstance().getUser(status.user_id);
                              if (user != null) {
                            ...
                            MessagesStorage.getInstance()
                                .updateUsers(dbUsersStatus, true, true, true);
                          }
                          NotificationCenter.getInstance()
                              .postNotificationName(
                                  NotificationCenter.updateInterfaces,
                  ...
                  AndroidUtilities.runOnUIThread(
                      new Runnable() {
                        ...
                        public void run() {
                          ...
                          NotificationCenter.getInstance()
                              .postNotificationName(NotificationCenter.privacyRulesUpdated);
                        }
                      });
                }
              });
                ...
                public void run(final TLObject response, final TLRPC.TL_error error) {
                  AndroidUtilities.runOnUIThread(
                      new Runnable() {
                        ...
                        public void run() {
                          if (error == null) {
                            TLRPC.TL_account_privacyRules rules =
                                (TLRPC.TL_account_privacyRules) response;
