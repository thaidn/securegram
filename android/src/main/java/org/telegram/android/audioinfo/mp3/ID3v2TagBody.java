...
public class ID3v2TagBody {
  ...
  ID3v2TagBody(InputStream delegate, long position, int length, ID3v2TagHeader tagHeader)
      throws IOException {
  ...
  public ID3v2FrameBody frameBody(ID3v2FrameHeader frameHeader) throws IOException, ID3v2Exception {
    ...
    return new ID3v2FrameBody(
        input, frameHeader.getHeaderSize(), dataLength, tagHeader, frameHeader);
  }
