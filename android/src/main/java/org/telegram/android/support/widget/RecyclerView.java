...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
  ...
  private static final boolean FORCE_INVALIDATE_DISPLAY_LIST =
      Build.VERSION.SDK_INT == 18 || Build.VERSION.SDK_INT == 19 || Build.VERSION.SDK_INT == 20;
  ...
  private void createLayoutManager(
      Context context, String className, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    if (className != null) {
  ...
  private void setAdapterInternal(
      Adapter adapter, boolean compatibleWithPrevious, boolean removeAndRecycleViews) {
    if (mAdapter != null) {
  ...
  public void addItemDecoration(ItemDecoration decor, int index) {
    if (mLayout != null) {
      mLayout.assertNotInLayoutOrScroll(
  ...
  public void scrollToPosition(int position) {
    ...
    if (mLayout == null) {
      Log.e(
          TAG,
          "Cannot scroll to position a LayoutManager set. "
  ...
  public void smoothScrollToPosition(int position) {
    if (mLayout == null) {
      Log.e(
          TAG,
          "Cannot smooth scroll without a LayoutManager set. "
              + "Call setLayoutManager with a non-null argument.");
      return;
    }
  ...
  public void scrollBy(int x, int y) {
    if (mLayout == null) {
      Log.e(
          TAG,
          "Cannot scroll without a LayoutManager set. "
              + "Call setLayoutManager with a non-null argument.");
      return;
    }
          ...
          if (holder != null && holder.mShadowingHolder != null) {
            ...
            if (shadowingView != null) {
              ...
              if (left != shadowingView.getLeft() || top != shadowingView.getTop()) {
                shadowingView.layout(
                    left, top, left + shadowingView.getWidth(), top + shadowingView.getHeight());
              }
            }
          }
        }
  ...
  public boolean fling(int velocityX, int velocityY) {
    if (mLayout == null) {
      Log.e(
          TAG,
          "Cannot fling without a LayoutManager set. "
              + "Call setLayoutManager with a non-null argument.");
      return false;
    }
  ...
  void dispatchLayout() {
    ...
    if (mState.mRunSimpleAnimations) {
      ...
      for (int i = 0; i < count; ++i) {
        ...
        mState.mPreLayoutHolderMap.put(
            holder,
            new ItemHolderInfo(
                holder, view.getLeft(), view.getTop(), view.getRight(), view.getBottom()));
      }
    }
    if (mState.mRunPredictiveAnimations) {
    ...
    if (mState.mRunSimpleAnimations) {
      ...
      ArrayMap<Long, ViewHolder> newChangedHolders =
          mState.mOldChangedHolders != null ? new ArrayMap<Long, ViewHolder>() : null;
      int count = mChildHelper.getChildCount();
      for (int i = 0; i < count; ++i) {
        ...
        if (newChangedHolders != null && mState.mOldChangedHolders.get(key) != null) {
          ...
          mState.mPostLayoutHolderMap.put(
              holder,
              new ItemHolderInfo(
                  holder, view.getLeft(), view.getTop(), view.getRight(), view.getBottom()));
        }
      ...
      if (postLayoutCount > 0) {
        for (int i = postLayoutCount - 1; i >= 0; i--) {
          ...
          if ((mState.mPreLayoutHolderMap.isEmpty()
            ...
            Rect initialBounds =
                (appearingViewInitialBounds != null)
      ...
      for (int i = 0; i < count; ++i) {
        ...
        if (preInfo != null && postInfo != null) {
          if (preInfo.left != postInfo.left || preInfo.top != postInfo.top) {
            ...
            if (mItemAnimator.animateMove(
                postHolder, preInfo.left, preInfo.top, postInfo.left, postInfo.top)) {
              postAnimationRunner();
            }
          }
        }
  ...
  protected void removeDetachedView(View child, boolean animate) {
    ...
    if (vh != null) {
      if (vh.isTmpDetached()) {
        ...
        throw new IllegalArgumentException(
            "Called removeDetachedView with a view which"
                + " is not flagged as tmp detached."
                + vh);
      }
    }
    dispatchChildDetached(child);
    ...
    for (int i = disappearingList.size() - 1; i >= 0; i--) {
      ...
      if (info != null) {
        ...
        animateDisappearance(
            new ItemHolderInfo(
                vh, view.getLeft(), view.getTop(), view.getRight(), view.getBottom()));
      }
    }
  ...
  private void animateAppearance(
      ViewHolder itemHolder, Rect beforeBounds, int afterLeft, int afterTop) {
    ...
    if (beforeBounds != null && (beforeBounds.left != afterLeft || beforeBounds.top != afterTop)) {
      ...
      if (mItemAnimator.animateMove(
          itemHolder, beforeBounds.left, beforeBounds.top, afterLeft, afterTop)) {
        postAnimationRunner();
      }
    } else {
      if (DEBUG) {
  ...
  private void animateDisappearance(ItemHolderInfo disappearingItem) {
    ...
    if (oldLeft != newLeft || oldTop != newTop) {
      ...
      if (DEBUG) {
        Log.d(
            TAG, "DISAPPEARING: " + disappearingItem.holder + " with view " + disappearingItemView);
      }
  ...
  private void animateChange(ViewHolder oldHolder, ViewHolder newHolder) {
    ...
    if (mItemAnimator.animateChange(oldHolder, newHolder, fromLeft, fromTop, toLeft, toTop)) {
      postAnimationRunner();
    }
  }
  ...
  private class ViewFlinger implements Runnable {
    ...
    public void run() {
      ...
      if (scroller.computeScrollOffset()) {
        ...
        final boolean fullyConsumedVertical =
            dy != 0 && mLayout.canScrollVertically() && vresult == dy;
        final boolean fullyConsumedHorizontal =
            dx != 0 && mLayout.canScrollHorizontally() && hresult == dx;
    ...
    private int computeScrollDuration(int dx, int dy, int vx, int vy) {
      ...
      final float distance =
          halfContainerSize + halfContainerSize * distanceInfluenceForSnapDuration(distanceRatio);
  ...
  public final class Recycler {
    ...
    public void bindViewToPosition(View view, int position) {
      ...
      if (holder == null) {
        throw new IllegalArgumentException(
            "The view does not have a ViewHolder. You cannot"
    ...
    public int convertPreLayoutPositionToPostLayout(int position) {
      if (position < 0 || position >= mState.getItemCount()) {
        throw new IndexOutOfBoundsException(
            "invalid position " + position + ". State " + "item count is " + mState.getItemCount());
      }
      if (!mState.isPreLayout()) {
        return position;
      }
      ...
      if (mAccessibilityManager != null && mAccessibilityManager.isEnabled()) {
        if (ViewCompat.getImportantForAccessibility(itemView)
          ...
          ViewCompat.setImportantForAccessibility(
              itemView, ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_YES);
        }
    ...
    void recycleViewHolderInternal(ViewHolder holder) {
      ...
      if (holder.isTmpDetached()) {
        throw new IllegalArgumentException(
            "Tmp detached view should be removed "
                + "from RecyclerView before it can be recycled: "
                + holder);
      }

      if (holder.shouldIgnore()) {
        throw new IllegalArgumentException(
            "Trying to recycle an ignored view holder. You"
      ...
      if (forceRecycle || holder.isRecyclable()) {
        ...
        Log.d(
            TAG,
            "trying to recycle a non-recycleable holder. Hopefully, it will "
            ...
            if (holder.isRemoved()) {
              ...
              if (!mState.isPreLayout()) {
                holder.setFlags(
                    ...
                    ViewHolder.FLAG_UPDATE | ViewHolder.FLAG_INVALID | ViewHolder.FLAG_REMOVED);
              }
            }
            return holder;
          } else if (!dryRun) {
  ...
  public static abstract class LayoutManager {
    ...
    private void addViewInt(View child, int index, boolean disappearing) {
      ...
      if (holder.wasReturnedFromScrap() || holder.isScrap()) {
        ...
        if (currentIndex == -1) {
          throw new IllegalStateException(
              "Added View has RecyclerView as parent but"
    ...
    public View findViewByPosition(int position) {
      ...
      for (int i = 0; i < childCount; i++) {
        ...
        if (vh.getLayoutPosition() == position
            && !vh.shouldIgnore()
    ...
    public void moveView(int fromIndex, int toIndex) {
      ...
      if (view == null) {
        throw new IllegalArgumentException(
            "Cannot move a child from non-existing index:" + fromIndex);
      }
    ...
    public void measureChild(View child, int widthUsed, int heightUsed) {
      ...
      final int widthSpec =
          getChildMeasureSpec(
              getWidth(),
              getPaddingLeft() + getPaddingRight() + widthUsed,
              lp.width,
              canScrollHorizontally());
      final int heightSpec =
          getChildMeasureSpec(
              getHeight(),
              getPaddingTop() + getPaddingBottom() + heightUsed,
              lp.height,
              canScrollVertically());
    ...
    public static int getChildMeasureSpec(
        int parentSize, int padding, int childDimension, boolean canScroll) {
    ...
    public boolean requestChildRectangleOnScreen(
      ...
      final int dy =
          offScreenTop != 0 ? offScreenTop : Math.min(childTop - parentTop, offScreenBottom);
    ...
    public void onInitializeAccessibilityNodeInfo(
        Recycler recycler, State state, AccessibilityNodeInfoCompat info) {
    ...
    public void onInitializeAccessibilityEvent(
        Recycler recycler, State state, AccessibilityEvent event) {
      final AccessibilityRecordCompat record = AccessibilityEventCompat.asRecord(event);
      if (mRecyclerView == null || record == null) {
        return;
      }
      record.setScrollable(
    ...
    void onInitializeAccessibilityNodeInfoForItem(View host, AccessibilityNodeInfoCompat info) {
      ...
      if (vh != null && !vh.isRemoved()) {
        onInitializeAccessibilityNodeInfoForItem(
            mRecyclerView.mRecycler, mRecyclerView.mState, host, info);
      }
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(
        Recycler recycler, State state, View host, AccessibilityNodeInfoCompat info) {
      int rowIndexGuess = canScrollVertically() ? getPosition(host) : 0;
      int columnIndexGuess = canScrollHorizontally() ? getPosition(host) : 0;
      final AccessibilityNodeInfoCompat.CollectionItemInfoCompat itemInfo =
          AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(
              rowIndexGuess, 1, columnIndexGuess, 1, false, false);
    ...
    boolean performAccessibilityAction(int action, Bundle args) {
      return performAccessibilityAction(
          mRecyclerView.mRecycler, mRecyclerView.mState, action, args);
    }
    ...
    public boolean performAccessibilityAction(
        Recycler recycler, State state, int action, Bundle args) {
      if (mRecyclerView == null) {
        return false;
      }
    ...
    boolean performAccessibilityActionForItem(View view, int action, Bundle args) {
      return performAccessibilityActionForItem(
          mRecyclerView.mRecycler, mRecyclerView.mState, view, action, args);
    }
    ...
    public boolean performAccessibilityActionForItem(
        Recycler recycler, State state, View view, int action, Bundle args) {
      return false;
    }
  ...
  public static abstract class ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, State state) {
      getItemOffsets(
          outRect, ((LayoutParams) view.getLayoutParams()).getViewLayoutPosition(), parent);
    }
  }
      ...
      if (mIsRecyclableCount < 0) {
        ...
        if (DEBUG) {
          throw new RuntimeException(
              "isRecyclable decremented below 0: "
                  + "unmatched pair of setIsRecyable() calls for "
                  + this);
        }
        Log.e(
            VIEW_LOG_TAG,
  ...
  public static abstract class SmoothScroller {
    ...
    protected void normalize(PointF scrollVector) {
      final double magnitute =
          Math.sqrt(scrollVector.x * scrollVector.x + scrollVector.y * scrollVector.y);
  ...
  public static abstract class ItemAnimator {
     ...
     * false otherwise.
     */
    abstract public boolean animateChange(
