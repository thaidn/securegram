...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
                ...
                if (pointerId == mActivePointerId) {
                  if (mVelocityTracker != null) {
                    mVelocityTracker.computeCurrentVelocity(
                        1000, mRecyclerView.getMaxFlingVelocity());
                  }
  ...
  private int swipeIfNecessary(ViewHolder viewHolder) {
    ...
    final int absoluteMovementFlags =
        mCallback.convertToAbsoluteDirection(
            originalMovementFlags, ViewCompat.getLayoutDirection(mRecyclerView));
    final int flags =
      ...
      if ((swipeDir = checkHorizontalSwipe(viewHolder, flags)) > 0) {
        ...
        if ((originalFlags & swipeDir) == 0) {
          ...
          return Callback.convertToRelativeDirection(
              swipeDir, ViewCompat.getLayoutDirection(mRecyclerView));
        }
        return swipeDir;
      }
  ...
  public abstract static class Callback {
    ...
    public ViewHolder chooseDropTarget(
        ViewHolder selected, List<ViewHolder> dropTargets, int curX, int curY) {
