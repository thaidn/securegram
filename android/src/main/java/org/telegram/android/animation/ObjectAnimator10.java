...
public final class ObjectAnimator10 extends ValueAnimator {
  ...
  static {
    Property<View, Float> ALPHA =
        new FloatProperty10<View>("alpha") {
          @Override
    ...
    Property<View, Float> PIVOT_X =
        new FloatProperty10<View>("pivotX") {
          @Override
          public void setValue(View object, float value) {
    ...
    Property<View, Float> PIVOT_Y =
        new FloatProperty10<View>("pivotY") {
          @Override
          public void setValue(View object, float value) {
    ...
    Property<View, Float> TRANSLATION_X =
        new FloatProperty10<View>("translationX") {
          @Override
          public void setValue(View object, float value) {
    ...
    Property<View, Float> TRANSLATION_Y =
        new FloatProperty10<View>("translationY") {
          @Override
          public void setValue(View object, float value) {
    ...
    Property<View, Float> ROTATION =
        new FloatProperty10<View>("rotation") {
          @Override
          public void setValue(View object, float value) {
    ...
    Property<View, Float> ROTATION_X =
        new FloatProperty10<View>("rotationX") {
          @Override
          public void setValue(View object, float value) {
    ...
    Property<View, Float> ROTATION_Y =
        new FloatProperty10<View>("rotationY") {
          @Override
          public void setValue(View object, float value) {
    ...
    Property<View, Float> SCALE_X =
        new FloatProperty10<View>("scaleX") {
          @Override
          public void setValue(View object, float value) {
    ...
    Property<View, Float> SCALE_Y =
        new FloatProperty10<View>("scaleY") {
          @Override
          public void setValue(View object, float value) {
    ...
    Property<View, Integer> SCROLL_X =
        new IntProperty<View>("scrollX") {
          @Override
    ...
    Property<View, Integer> SCROLL_Y =
        new IntProperty<View>("scrollY") {
          @Override
          public void setValue(View object, int value) {
  ...
  public static <T> ObjectAnimator10 ofFloat(
  ...
  public static ObjectAnimator10 ofObject(
      Object target, String propertyName, TypeEvaluator evaluator, Object... values) {
    ObjectAnimator10 anim = new ObjectAnimator10(target, propertyName);
  ...
  public static <T, V> ObjectAnimator10 ofObject(
      T target, Property<T, V> property, TypeEvaluator<V> evaluator, V... values) {
    ObjectAnimator10 anim = new ObjectAnimator10(target, property);
    anim.setObjectValues(values);
    anim.setEvaluator(evaluator);
    return anim;
  ...
  public static ObjectAnimator10 ofPropertyValuesHolder(
