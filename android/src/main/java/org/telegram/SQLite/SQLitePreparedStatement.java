...
public class SQLitePreparedStatement {
  ...
  public SQLitePreparedStatement(SQLiteDatabase db, String sql, boolean finalize)
  ...
  native void bindByteBuffer(int statementHandle, int index, ByteBuffer value, int length)
      throws SQLiteException;
