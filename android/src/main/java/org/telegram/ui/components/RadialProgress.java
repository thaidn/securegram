...
public class RadialProgress {
  ...
  private void invalidateParent() {
    ...
    parent.invalidate(
        (int) progressRect.left - offset,
        (int) progressRect.top - offset,
        (int) progressRect.right + offset * 2,
        (int) progressRect.bottom + offset * 2);
  }
  ...
  public void onDraw(Canvas canvas) {
    if (previousDrawable != null) {
      ...
      previousDrawable.setBounds(
          (int) progressRect.left,
          (int) progressRect.top,
          (int) progressRect.right,
          (int) progressRect.bottom);
    ...
    if (currentWithRound || previousWithRound) {
      ...
      cicleRect.set(
          progressRect.left + diff,
          progressRect.top + diff,
          progressRect.right - diff,
