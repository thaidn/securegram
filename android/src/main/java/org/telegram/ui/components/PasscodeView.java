...
public class PasscodeView extends FrameLayout {
  ...
  private class AnimatingTextView extends FrameLayout {
    ...
    private int getXForTextView(int pos) {
      return (getMeasuredWidth() - stringBuilder.length() * AndroidUtilities.dp(30)) / 2
          + pos * AndroidUtilities.dp(30)
    ...
    public void appendCharacter(String c) {
      ...
      animators.add(
          ObjectAnimatorProxy.ofFloat(textView, "translationY", AndroidUtilities.dp(20), 0));
  ...
  private void shakeTextView(final float x, final int num) {
    ...
    AnimatorSetProxy animatorSetProxy = new AnimatorSetProxy();
    animatorSetProxy.playTogether(
        ObjectAnimatorProxy.ofFloat(passcodeTextView, "translationX", AndroidUtilities.dp(x)));
  ...
  public void onShow() {
    ...
    passcodeTextView.setText(
        LocaleController.getString("EnterYourPasscode", R.string.EnterYourPasscode));
        ...
        top =
            layoutParams1.topMargin =
                layoutParams.topMargin =
                    sizeBetweenNumbersY + (sizeBetweenNumbersY + AndroidUtilities.dp(50)) * row;
        layoutParams1.leftMargin =
            layoutParams.leftMargin =
                sizeBetweenNumbersX + (sizeBetweenNumbersX + AndroidUtilities.dp(50)) * col;
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (backgroundDrawable != null) {
      if (backgroundDrawable instanceof ColorDrawable) {
        ...
        float scaleY =
            (float) (getMeasuredHeight() + keyboardHeight)
                / (float) backgroundDrawable.getIntrinsicHeight();
