...
public class EmojiView extends FrameLayout
  ...
  public EmojiView(boolean needStickers, Context context) {
    ...
    if (showStickers) {
      ...
      scrollSlidingTabStrip =
          new ScrollSlidingTabStrip(context) {
      ...
      updateStickerTabs();
      scrollSlidingTabStrip.setDelegate(
          new ScrollSlidingTabStrip.ScrollSlidingTabStripDelegate() {
            ...
            public void onPageSelected(int page) {
              ...
              views
                  .get(6)
                  .setSelection(stickersGridAdapter.getPositionForPack(stickerSets.get(index)));
            }
          });
      ...
      gridView.setOnScrollListener(
          new AbsListView.OnScrollListener() {
            ...
            public void onScroll(
              ...
              scrollSlidingTabStrip.onPageScrolled(
                  stickersGridAdapter.getTabForPosition(firstVisibleItem) + 1, 0);
            }
          });
    }
    ...
    pagerSlidingTabStripContainer.addView(
        pagerSlidingTabStrip, LayoutHelper.createLinear(0, 48, 1.0f));
  ...
  private void onPageScrolled(int position, int width, int positionOffsetPixels) {
    ...
    if (ViewProxy.getTranslationX(pagerSlidingTabStripContainer) != margin) {
      ...
      if (Build.VERSION.SDK_INT < 11) {
        ...
        && pagerSlidingTabStripContainer.getVisibility() == GONE) {
      pagerSlidingTabStripContainer.clearAnimation();
      pagerSlidingTabStripContainer.setVisibility(GONE);
    }
  }
  ...
  private void saveRecents() {
    ...
    getContext()
        ...
        .edit()
        .putString("recents", TextUtils.join(",", arrayList))
        .commit();
  }

  private void saveRecentStickers() {
    SharedPreferences preferences =
        getContext().getSharedPreferences("emoji", Activity.MODE_PRIVATE);
  ...
  public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    FrameLayout.LayoutParams layoutParams =
        (FrameLayout.LayoutParams) pagerSlidingTabStripContainer.getLayoutParams();
    ...
    super.onMeasure(
        ...
        View.MeasureSpec.makeMeasureSpec(
            View.MeasureSpec.getSize(heightMeasureSpec), MeasureSpec.EXACTLY));
  }
      ...
      if (sticker != null) {
        ...
        if (i == totalItems) {
          ...
          if (pack == null) {
            ...
            int height =
                pager.getHeight()
                    - (int) Math.ceil(pack.documents.size() / (float) stickersPerRow)
                        * AndroidUtilities.dp(82);
            ...
            new View.OnClickListener() {
              public void onClick(View view) {
                if (EmojiView.this.listener != null) {
                  EmojiView.this
                      .listener.onEmojiSelected(EmojiView.this.convert((Long) view.getTag()));
                }
