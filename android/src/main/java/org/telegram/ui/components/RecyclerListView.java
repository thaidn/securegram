...
public class RecyclerListView extends RecyclerView {
  ...
  private class RecyclerListViewItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public boolean onInterceptTouchEvent(RecyclerView view, MotionEvent e) {
      ...
      boolean isScrollIdle =
          RecyclerListView.this.getScrollState() == RecyclerListView.SCROLL_STATE_IDLE;
        ...
        if (currentChildView != null) {
          ...
          MotionEvent childEvent =
              MotionEvent.obtain(
                  ...
                  0,
                  e.getActionMasked(),
                  e.getX() - currentChildView.getLeft(),
                  e.getY() - currentChildView.getTop(),
                  0);
  ...
  public boolean onInterceptTouchEvent(MotionEvent e) {
    ...
    return onInterceptTouchListener != null && onInterceptTouchListener.onInterceptTouchEvent(e)
