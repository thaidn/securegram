...
public class WebFrameLayout extends FrameLayout {
  ...
  public WebFrameLayout(
      Context context,
      BottomSheet parentDialog,
      String title,
      String originalUrl,
      final String url,
      int w,
    ...
    addView(
        linearLayout,
        LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 32, Gravity.LEFT | Gravity.TOP));
    ...
    linearLayout.addView(
        textView, LayoutHelper.createLinear(0, LayoutHelper.MATCH_PARENT, 1.0f, 16, 0, 0, 0));
    ...
    linearLayout.addView(
        ...
        LayoutHelper.createLinear(
            LayoutHelper.WRAP_CONTENT, LayoutHelper.MATCH_PARENT, 16, 0, 0, 0));
    ...
    linearLayout.addView(
        textView,
        LayoutHelper.createLinear(
            LayoutHelper.WRAP_CONTENT, LayoutHelper.MATCH_PARENT, 16, 0, 16, 0));
    textView.setOnClickListener(
        new OnClickListener() {
          @Override
          public void onClick(View v) {
            try {
              if (Build.VERSION.SDK_INT < 11) {
                ...
                android.content.ClipData clip =
                    android.content.ClipData.newPlainText("label", openUrl);
    ...
    addView(
        ...
        LayoutHelper.createFrame(
            LayoutHelper.MATCH_PARENT, 1, Gravity.TOP | Gravity.LEFT, 0, 40, 0, 0));
        ...
        new WebChromeClient() {
          ...
          public void onHideCustomView() {
            ...
            if (customViewCallback != null
                && !customViewCallback.getClass().getName().contains(".chromium.")) {
    ...
    addView(
        progressBar,
        LayoutHelper.createFrame(
            LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER, 8, 24, 8, 0));
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    super.onMeasure(
        widthMeasureSpec,
        MeasureSpec.makeMeasureSpec(h + AndroidUtilities.dp(49), MeasureSpec.EXACTLY));
  }
}
