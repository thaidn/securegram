...
public class DrawerPlayerView extends FrameLayout
  ...
  public DrawerPlayerView(Context context, ListView listView) {
    ...
    addView(
        titleTextView,
        LayoutHelper.createFrame(
            LayoutHelper.MATCH_PARENT, 48, Gravity.LEFT | Gravity.TOP, 72, 3, 8, 0));
    ...
    if (messageObject == null || !messageObject.isMusic()) {
      ...
      if (getVisibility() != GONE) {
        ...
        FrameLayout.LayoutParams layoutParams =
            (FrameLayout.LayoutParams) parentListView.getLayoutParams();
      ...
      if (lastMessageObject != messageObject) {
        ...
        titleTextView.setText(
            String.format(
                "%s - %s", messageObject.getMusicAuthor(), messageObject.getMusicTitle()));
      }
    }
  }
}
