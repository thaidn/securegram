...
public class DialogsActivity extends BaseFragment
  ...
  public boolean onFragmentCreate() {
    ...
    if (searchString == null) {
      ...
      NotificationCenter.getInstance()
          .addObserver(this, NotificationCenter.messageReceivedByServer);
  ...
  public void onFragmentDestroy() {
    ...
    if (searchString == null) {
      ...
      NotificationCenter.getInstance()
          .removeObserver(this, NotificationCenter.messageReceivedByAck);
      NotificationCenter.getInstance()
  ...
  public View createView(final Context context) {
          ...
          public void onItemClick(View view, int position) {
            ...
            if (adapter == dialogsAdapter) {
              ...
              if (obj instanceof TLRPC.User) {
                ...
                dialogsSearchAdapter.addHashtagsFromMessage(
                    dialogsSearchAdapter.getLastSearchString());
          ...
          public void onItemClick(View view, int position) {
                ...
                if (adapter == dialogsSearchAdapter) {
                  ...
                  if (item instanceof String) {
                    ...
                    builder.setPositiveButton(
                        LocaleController.getString("ClearButton", R.string.ClearButton)
                            .toUpperCase(),
            ...
            builder.setItems(
                new CharSequence[] {
                  ...
                  isChat
                      ? LocaleController.getString("DeleteChat", R.string.DeleteChat)
                    ...
                    if (which == 0) {
                      builder.setMessage(
                          LocaleController.getString(
                              "AreYouSureClearHistory", R.string.AreYouSureClearHistory));
                    } else {
                      if (isChat) {
                        builder.setMessage(
                            LocaleController.getString(
                            ...
                            if (which != 0) {
                              if (isChat) {
                                TLRPC.Chat currentChat =
                                    MessagesController.getInstance().getChat((int) -selectedDialog);
                                if (currentChat != null && currentChat.left
                                    || currentChat instanceof TLRPC.TL_chatForbidden) {
                                  MessagesController.getInstance()
                                      .deleteDialog(selectedDialog, 0, false);
                                } else {
                                  MessagesController.getInstance()
                                      .deleteUserFromChat(
                                          (int) -selectedDialog,
                              ...
                              MessagesController.getInstance()
                                  .deleteDialog(selectedDialog, 0, true);
                            }
                          }
                        });
                    builder.setNegativeButton(
    ...
    emptyView.addView(
        textView, LayoutHelper.createLinear(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT));
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      ...
      animator.addState(
          ...
          ObjectAnimator.ofFloat(
                  floatingButton, "translationZ", AndroidUtilities.dp(2), AndroidUtilities.dp(4))
              .setDuration(200));
      animator.addState(
          new int[] {},
          ObjectAnimator.ofFloat(
                  floatingButton, "translationZ", AndroidUtilities.dp(4), AndroidUtilities.dp(2))
              .setDuration(200));
      floatingButton.setStateListAnimator(animator);
      floatingButton.setOutlineProvider(
        ...
        new RecyclerView.OnScrollListener() {
          ...
          public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            int visibleItemCount =
                Math.abs(layoutManager.findLastVisibleItemPosition() - firstVisibleItem) + 1;
            ...
            if (visibleItemCount > 0) {
              if (layoutManager.findLastVisibleItemPosition() == getDialogsArray().size()) {
                MessagesController.getInstance()
                    .loadDialogs(
                        MessagesController.getInstance().dialogs.size(),
                        MessagesController.getInstance().dialogsServerOnly.size(),
                        100,
                        true);
              }
            }
    ...
    dialogsSearchAdapter.setDelegate(
        new DialogsSearchAdapter.MessagesActivitySearchAdapterDelegate() {
          @Override
              ...
              new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                  ViewProxy.setTranslationY(
                      floatingButton, floatingHidden ? AndroidUtilities.dp(100) : 0);
  ...
  private void hideFloatingButton(boolean hide) {
    ...
    floatingHidden = hide;
    ObjectAnimatorProxy animator =
        ObjectAnimatorProxy.ofFloatProxy(
                floatingButton, "translationY", floatingHidden ? AndroidUtilities.dp(100) : 0)
            .setDuration(300);
  ...
  private void didSelectResult(final long dialog_id, boolean useAlert, final boolean param) {
    if (useAlert
        && (selectAlertString != null && selectAlertStringGroup != null
            || addToGroupAlertString != null)) {
      ...
      if (lower_part != 0) {
        if (high_id == 1) {
          ...
          builder.setMessage(
              LocaleController.formatStringSimple(selectAlertStringGroup, chat.title));
        } else {
          if (lower_part > 0) {
            ...
            builder.setMessage(
                LocaleController.formatStringSimple(
                    selectAlertString, UserObject.getUserName(user)));
          } else if (lower_part < 0) {
            TLRPC.Chat chat = MessagesController.getInstance().getChat(-lower_part);
            if (chat == null) {
              return;
            ...
            if (addToGroupAlertString != null) {
              builder.setMessage(
                  LocaleController.formatStringSimple(addToGroupAlertString, chat.title));
            } else {
              builder.setMessage(
                  LocaleController.formatStringSimple(selectAlertStringGroup, chat.title));
            }
        ...
        builder.setMessage(
            LocaleController.formatStringSimple(selectAlertString, UserObject.getUserName(user)));
      }
