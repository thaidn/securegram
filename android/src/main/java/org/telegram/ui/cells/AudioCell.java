...
public class AudioCell extends FrameLayout {
  ...
  public AudioCell(Context context) {
    ...
    addView(
        ...
        LayoutHelper.createFrame(
            ...
            LocaleController.isRTL ? 0 : 13,
            13,
            LocaleController.isRTL ? 13 : 0,
            0));
    playButton.setOnClickListener(
        new OnClickListener() {
          ...
          public void onClick(View v) {
            if (audioEntry != null) {
              if (MediaController.getInstance().isPlayingAudio(audioEntry.messageObject)
                ...
                if (MediaController.getInstance()
                    .setPlaylist(arrayList, audioEntry.messageObject)) {
    ...
    addView(
        ...
        LayoutHelper.createFrame(
            ...
            (LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT) | Gravity.TOP,
            LocaleController.isRTL ? 50 : 72,
            7,
            LocaleController.isRTL ? 72 : 50,
            0));
    ...
    addView(
        ...
        LayoutHelper.createFrame(
            ...
            LocaleController.isRTL ? 18 : 0,
            11,
            LocaleController.isRTL ? 0 : 18,
            0));
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    super.onMeasure(
        ...
        MeasureSpec.makeMeasureSpec(
            AndroidUtilities.dp(72) + (needDivider ? 1 : 0), MeasureSpec.EXACTLY));
  }
  ...
  public void setAudio(MediaController.AudioEntry entry, boolean divider, boolean checked) {
    ...
    timeTextView.setText(
        String.format("%d:%02d", audioEntry.duration / 60, audioEntry.duration % 60));
    playButton.setImageResource(
        MediaController.getInstance().isPlayingAudio(audioEntry.messageObject)
                && !MediaController.getInstance().isAudioPaused()
            ? R.drawable.audiosend_pause
            : R.drawable.audiosend_play);
