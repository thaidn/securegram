...
public class PhotoPickerSearchCell extends LinearLayout {
  ...
  public PhotoPickerSearchCell(Context context) {
    ...
    searchButton.textView1.setText(
        LocaleController.getString("SearchImages", R.string.SearchImages));
    searchButton.textView2.setText(
        LocaleController.getString("SearchImagesInfo", R.string.SearchImagesInfo));
