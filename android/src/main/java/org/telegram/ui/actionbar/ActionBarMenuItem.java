...
public class ActionBarMenuItem extends FrameLayoutFixed {
  ...
  public TextView addSubItem(int id, String text, int icon) {
    if (popupLayout == null) {
      ...
      popupLayout.setOnTouchListener(
          new OnTouchListener() {
            @Override
      ...
      popupLayout.setDispatchKeyEventListener(
          new ActionBarPopupWindow.OnDispatchKeyEventListener() {
            @Override
    ...
    if (icon != 0) {
      ...
      if (!LocaleController.isRTL) {
        ...
        textView.setCompoundDrawablesWithIntrinsicBounds(
            null, null, getResources().getDrawable(icon), null);
      }
    }
    popupLayout.setShowedFromBotton(showFromBottom);
  ...
  public void openSearch() {
    if (searchContainer == null
        || searchContainer.getVisibility() == VISIBLE
        || parentMenu == null) {
      return;
    }
  ...
  public ActionBarMenuItem setIsSearchField(boolean value, boolean needClearButton) {
    ...
    if (value && searchContainer == null) {
      ...
      LinearLayout.LayoutParams layoutParams =
          (LinearLayout.LayoutParams) searchContainer.getLayoutParams();
      ...
      FrameLayout.LayoutParams layoutParams2 =
          (FrameLayout.LayoutParams) searchField.getLayoutParams();
  ...
  public ActionBarMenuItem setActionBarMenuItemSearchListener(
      ActionBarMenuItemSearchListener listener) {
      ...
      if (showFromBottom) {
        if (show) {
          popupWindow.showAsDropDown(
              this, -popupLayout.getMeasuredWidth() + getMeasuredWidth(), offsetY);
        }
        if (update) {
          popupWindow.update(
              this, -popupLayout.getMeasuredWidth() + getMeasuredWidth(), offsetY, -1, -1);
        }
      } else {
        if (parentMenu != null) {
