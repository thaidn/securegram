      ...
      if (animationEnabled) {
        ...
        if (showedFromBotton) {
          for (int a = lastStartedChild; a >= 0; a--) {
            ...
            if (height - (position * AndroidUtilities.dp(48) + AndroidUtilities.dp(32))
                > value * height) {
              break;
            }
          ...
          for (int a = lastStartedChild; a < count; a++) {
            ...
            int position = positions.get(child);
            if ((position + 1) * AndroidUtilities.dp(48) - AndroidUtilities.dp(24)
                > value * height) {
              break;
            }
            lastStartedChild = a + 1;
      ...
      if (backgroundDrawable != null) {
        ...
        if (showedFromBotton) {
          backgroundDrawable.setBounds(
              0,
              (int) (getMeasuredHeight() * (1.0f - backScaleY)),
          ...
          backgroundDrawable.setBounds(
              ...
              0,
              (int) (getMeasuredWidth() * backScaleX),
              (int) (getMeasuredHeight() * backScaleY));
        }
