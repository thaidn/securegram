...
void ScaleARGBRowDownEven_C(const uint8* src_ptr, int, int src_stepx,
                            uint8* dst_ptr, int dst_width);

static void ARGBTranspose(const uint8* src, int src_stride, uint8* dst,
...
void ARGBRotate90(const uint8* src, int src_stride, uint8* dst, int dst_stride,
...
void ARGBRotate270(const uint8* src, int src_stride, uint8* dst, int dst_stride,
                   int width, int height) {
...
void ARGBRotate180(const uint8* src, int src_stride, uint8* dst, int dst_stride,
                   int width, int height) {
