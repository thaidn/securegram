...
static void ScalePlaneDown2(int src_width, int src_height, int dst_width,
                            int dst_height, int src_stride, int dst_stride,
  ...
  if (TestCpuFlag(kCpuHasSSE2) && IS_ALIGNED(dst_width, 16)) {
    ...
    if (IS_ALIGNED(src_ptr, 16) && IS_ALIGNED(src_stride, 16) &&
        IS_ALIGNED(row_stride, 16) && IS_ALIGNED(dst_ptr, 16) &&
  ...
  if (TestCpuFlag(kCpuHasMIPS_DSPR2) && IS_ALIGNED(src_ptr, 4) &&
    ...
    ScaleRowDown2 =
        filtering ? ScaleRowDown2Box_MIPS_DSPR2 : ScaleRowDown2_MIPS_DSPR2;
  }
#endif
...
static void ScalePlaneDown2_16(int src_width, int src_height, int dst_width,
  ...
  if (TestCpuFlag(kCpuHasMIPS_DSPR2) && IS_ALIGNED(src_ptr, 4) &&
      IS_ALIGNED(src_stride, 4) && IS_ALIGNED(row_stride, 4) &&
      IS_ALIGNED(dst_ptr, 4) && IS_ALIGNED(dst_stride, 4)) {
    ScaleRowDown2 = filtering ? ScaleRowDown2Box_16_MIPS_DSPR2
                              : ScaleRowDown2_16_MIPS_DSPR2;
  }
#endif
...
static void ScalePlaneDown4(int src_width, int src_height, int dst_width,
  ...
  if (TestCpuFlag(kCpuHasSSE2) && IS_ALIGNED(dst_width, 8) &&
      IS_ALIGNED(row_stride, 16) && IS_ALIGNED(src_ptr, 16) &&
      IS_ALIGNED(src_stride, 16)) {
  ...
  if (TestCpuFlag(kCpuHasMIPS_DSPR2) && IS_ALIGNED(row_stride, 4) &&
      ...
      IS_ALIGNED(dst_ptr, 4) && IS_ALIGNED(dst_stride, 4)) {
    ScaleRowDown4 =
        filtering ? ScaleRowDown4Box_MIPS_DSPR2 : ScaleRowDown4_MIPS_DSPR2;
  }
#endif
...
static void ScalePlaneDown4_16(int src_width, int src_height, int dst_width,
  ...
  if (TestCpuFlag(kCpuHasMIPS_DSPR2) && IS_ALIGNED(row_stride, 4) &&
      IS_ALIGNED(src_ptr, 4) && IS_ALIGNED(src_stride, 4) &&
      IS_ALIGNED(dst_ptr, 4) && IS_ALIGNED(dst_stride, 4)) {
    ScaleRowDown4 = filtering ? ScaleRowDown4Box_16_MIPS_DSPR2
                              : ScaleRowDown4_16_MIPS_DSPR2;
  }
#endif
...
static void ScalePlaneBoxRow_C(int dst_width, int boxheight, int x, int dx,
                               ptrdiff_t src_stride, const uint8* src_ptr,
                               uint8* dst_ptr) {
  int i;
  int boxwidth;
...
static void ScalePlaneBoxRow_16_C(int dst_width, int boxheight, int x, int dx,
                                  ptrdiff_t src_stride, const uint16* src_ptr,
                                  uint16* dst_ptr) {
  int i;
  int boxwidth;
...
// averaging.
static void ScalePlaneBox(int src_width, int src_height, int dst_width,
                          int dst_height, int src_stride, int dst_stride,
                          const uint8* src_ptr, uint8* dst_ptr) {
  int j;
...
static void ScalePlaneBox_16(int src_width, int src_height, int dst_width,
                             int dst_height, int src_stride, int dst_stride,
                             const uint16* src_ptr, uint16* dst_ptr) {
  int j;
  // Initial source x/y coordinate and step values as 16.16 fixed point.
...
void ScalePlaneBilinearDown(int src_width, int src_height, int dst_width,
                            int dst_height, int src_stride, int dst_stride,
                            const uint8* src_ptr, uint8* dst_ptr,
                            enum FilterMode filtering) {
  // Initial source x/y coordinate and step values as 16.16 fixed point.
...
void ScalePlaneBilinearDown_16(int src_width, int src_height, int dst_width,
                               int dst_height, int src_stride, int dst_stride,
                               const uint16* src_ptr, uint16* dst_ptr,
                               enum FilterMode filtering) {
  // Initial source x/y coordinate and step values as 16.16 fixed point.
...
void ScalePlaneBilinearUp(int src_width, int src_height, int dst_width,
                          int dst_height, int src_stride, int dst_stride,
                          const uint8* src_ptr, uint8* dst_ptr,
                          enum FilterMode filtering) {
  int j;
...
void ScalePlaneBilinearUp_16(int src_width, int src_height, int dst_width,
                             int dst_height, int src_stride, int dst_stride,
                             const uint16* src_ptr, uint16* dst_ptr,
                             enum FilterMode filtering) {
  int j;
...
// Deprecated api
LIBYUV_API
int ScaleOffset(const uint8* src, int src_width, int src_height, uint8* dst,
                int dst_width, int dst_height, int dst_yoffset,
