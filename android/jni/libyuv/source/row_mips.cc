...
void I422ToARGBRow_MIPS_DSPR2(const uint8* y_buf, const uint8* u_buf,
...
void I422ToABGRRow_MIPS_DSPR2(const uint8* y_buf, const uint8* u_buf,
                              const uint8* v_buf, uint8* rgb_buf, int width) {
  __asm__ __volatile__(
      ".set push                                \n"
      ".set noreorder                           \n"
...
void I422ToBGRARow_MIPS_DSPR2(const uint8* y_buf, const uint8* u_buf,
                              const uint8* v_buf, uint8* rgb_buf, int width) {
  __asm__ __volatile__(
      ".set push                                \n"
      ".set noreorder                           \n"
