...
static void ScaleARGBDown2(int src_width, int src_height, int dst_width,
                           ...
                           const uint8* src_argb, uint8* dst_argb, int x,
                           int dx, int y, int dy, enum FilterMode filtering) {
  int j;
  ...
  if (TestCpuFlag(kCpuHasNEON) && IS_ALIGNED(dst_width, 8) &&
    ...
    ScaleARGBRowDown2 =
        filtering ? ScaleARGBRowDown2Box_NEON : ScaleARGBRowDown2_NEON;
  }
#endif
...
// its original size.
static void ScaleARGBDown4Box(int src_width, int src_height, int dst_width,
                              int dst_height, int src_stride, int dst_stride,
                              const uint8* src_argb, uint8* dst_argb, int x,
                              int dx, int y, int dy) {
  int j;
...
static void ScaleARGBBilinearDown(int src_width, int src_height, int dst_width,
                                  int dst_height, int src_stride,
                                  int dst_stride, const uint8* src_argb,
                                  uint8* dst_argb, int x, int dx, int y, int dy,
                                  enum FilterMode filtering) {
  int j;
...
static void ScaleARGBBilinearUp(int src_width, int src_height, int dst_width,
                                int dst_height, int src_stride, int dst_stride,
                                const uint8* src_argb, uint8* dst_argb, int x,
                                int dx, int y, int dy,
                                enum FilterMode filtering) {
...
static void ScaleYUVToARGBBilinearUp(
    ...
    int src_stride_y, int src_stride_u, int src_stride_v, int dst_stride_argb,
    const uint8* src_y, const uint8* src_u, const uint8* src_v, uint8* dst_argb,
    int x, int dx, int y, int dy, enum FilterMode filtering) {
  int j;
...
static void ScaleARGB(const uint8* src, int src_stride, int src_width,
                      int src_height, uint8* dst, int dst_stride, int dst_width,
                      int dst_height, int clip_x, int clip_y, int clip_width,
                      int clip_height, enum FilterMode filtering) {
