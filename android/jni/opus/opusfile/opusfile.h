 ...
 * by the Xiph.Org Foundation and contributors http://www.xiphorg/ *
 *                                                                  *
 ********************************************************************
...
/**\mainpage
   ...
   <tt>libopusfile</tt> is implemented as a layer on top of Xiph.Org's
    reference
    <tt><a
   href="https://www.xiphorg/ogg/doc/libogg/reference.html">libogg</a></tt>
    and
    <tt><a
   href="https://mf4.xiphorg/jenkins/view/opus/job/opus/ws/doc/html/index.html">libopus</a></tt>
    libraries.
   ...
   The original sample rate is not preserved by the lossy compression, though
    ...
    but the
    <a
   href="http://www.speexorg/docs/manual/speex-manual/node7.html#SECTION00760000000000000000">the
...
/**The metadata from an Ogg Opus stream.
   ...
   See <a href="http://www.xiphorg/vorbis/doc/v-comment.html">the Vorbis
