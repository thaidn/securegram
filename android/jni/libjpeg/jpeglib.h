...
EXTERN(void)
jpeg_CreateDecompress JPP((j_decompress_ptr cinfo, int version,
                           size_t structsize));
...
EXTERN(void)
jpeg_set_linear_quality JPP((j_compress_ptr cinfo, int scale_factor,
                             boolean force_baseline));
EXTERN(void)
...
EXTERN(JDIMENSION)
jpeg_write_scanlines JPP((j_compress_ptr cinfo, JSAMPARRAY scanlines,
                          JDIMENSION num_lines));
EXTERN(void) jpeg_finish_compress JPP((j_compress_ptr cinfo));

/* Replaces jpeg_write_scanlines when writing raw downsampled data. */
EXTERN(JDIMENSION)
jpeg_write_raw_data JPP((j_compress_ptr cinfo, JSAMPIMAGE data,
                         JDIMENSION num_lines));
...
/* Same, but piecemeal. */
EXTERN(void)
jpeg_write_m_header JPP((j_compress_ptr cinfo, int marker,
                         unsigned int datalen));
...
EXTERN(JDIMENSION)
jpeg_read_scanlines JPP((j_decompress_ptr cinfo, JSAMPARRAY scanlines,
                         JDIMENSION max_lines));
EXTERN(JDIMENSION)
jpeg_read_scanlines_from JPP((j_decompress_ptr cinfo, JSAMPARRAY scanlines,
                              int line_offset, JDIMENSION max_lines));
EXTERN(JDIMENSION)
jpeg_read_tile_scanline JPP((j_decompress_ptr cinfo, huffman_index *index,
                             JSAMPARRAY scanlines));
EXTERN(void)
jpeg_init_read_tile_scanline JPP((j_decompress_ptr cinfo, huffman_index *index,
...
EXTERN(JDIMENSION)
jpeg_read_raw_data JPP((j_decompress_ptr cinfo, JSAMPIMAGE data,
                        JDIMENSION max_lines));
...
EXTERN(void)
jpeg_save_markers JPP((j_decompress_ptr cinfo, int marker_code,
...
EXTERN(boolean)
jpeg_build_huffman_index JPP((j_decompress_ptr cinfo, huffman_index *index));
EXTERN(void)
...
EXTERN(void)
jpeg_configure_huffman_index_scan(j_decompress_ptr cinfo, huffman_index *index,
                                  int scan_no, int offset);
