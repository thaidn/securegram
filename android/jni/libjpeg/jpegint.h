...
struct jpeg_input_controller {
  ...
  JMETHOD(int, consume_input_build_huffman_index,
          (j_decompress_ptr cinfo, huffman_index *index, int scan_count));
  JMETHOD(int, consume_markers,
          (j_decompress_ptr cinfo, huffman_index *index, int scan_count));
...
struct jpeg_d_coef_controller {
  ...
  JMETHOD(int, consume_data_build_huffman_index,
          (j_decompress_ptr cinfo, huffman_index *index, int scan_count));
...
struct jpeg_marker_reader {
  ...
  JMETHOD(void, get_sos_marker_position,
...
struct jpeg_entropy_decoder {
  ...
  JMETHOD(void, configure_huffman_decoder,
          (j_decompress_ptr cinfo, huffman_offset_data offset));
  JMETHOD(void, get_huffman_decoder_configuration,
          (j_decompress_ptr cinfo, huffman_offset_data *offset));
...
struct jpeg_color_quantizer {
  ...
  JMETHOD(void, color_quantize, (j_decompress_ptr cinfo, JSAMPARRAY input_buf,
                                 JSAMPARRAY output_buf, int num_rows));
...
EXTERN(void)
jset_input_stream_position JPP((j_decompress_ptr cinfo, int offset));
EXTERN(void)
jset_input_stream_position_bit JPP((j_decompress_ptr cinfo, int byte_offset,
                                    int bit_left, INT32 buf));
