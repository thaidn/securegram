...
#define JMESSAGE(code, string) code,
  ...
  JMESSAGE(JERR_ARITH_NOTIMPL,
      ...
      JMESSAGE(JERR_BAD_ALIGN_TYPE,
               ...
               "e "
               "fi"
               "x") JMESSAGE(JERR_BAD_ALLOC_CHUNK,
          ...
          JMESSAGE(JERR_BAD_BUFFER_MODE, "Bogus buffer control mode") JMESSAGE(
              ...
              "SOS") JMESSAGE(JERR_BAD_DCT_COEF,
                              "DCT "
                              "coefficient "
                              "out of range") JMESSAGE(JERR_BAD_DCTSIZE,
                                                       "IDCT output block size "
                                                       "%d not supported")
              JMESSAGE(JERR_BAD_HUFF_TABLE, "Bogus Huffman table definition") JMESSAGE(
                  ...
                  JMESSAGE(JERR_BAD_LENGTH, "Bogus marker length") JMESSAGE(
                      ...
                      JMESSAGE(JERR_BAD_PRECISION,
                          ...
                          JMESSAGE(
                              ...
                              "Invalid progressive "
                              "parameters at scan "
                              "script entry %d") JMESSAGE(JERR_BAD_SAMPLING,
                                                          "Bogus sampling "
                                                          "factors")
                                                      ...
                                                      JMESSAGE(JERR_DAC_INDEX,
                                                               ...
                                                               "index %d") JMESSAGE(JERR_DAC_VALUE,
                                                                                    ...
                                                                                    "0x%x") JMESSAGE(JERR_DHT_INDEX,
                                                                                                     "Bogus DHT "
                                                                                                     "index %d") JMESSAGE(JERR_DQT_INDEX,
                                                                                                                          "Bog"
                                                                                                                          "us "
                                                                                                                          "DQT"
                                                                                                                          " "
