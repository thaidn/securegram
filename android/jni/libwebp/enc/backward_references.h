...
// refs[0] or refs[1].
VP8LBackwardRefs* VP8LGetBackwardReferences(int width, int height,
...
int VP8LCalculateEstimateForCacheSize(const uint32_t* const argb, int xsize,
                                      int ysize, int quality,
                                      VP8LHashChain* const hash_chain,
