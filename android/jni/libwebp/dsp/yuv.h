...
// More information at: http://en.wikipediaorg/wiki/YCbCr
...
// See http://en.wikipediaorg/wiki/YCbCr#JPEG_conversion paragraph, and its
// difference with http://en.wikipediaorg/wiki/YCbCr#ITU-R_BT.601_conversion
// #define USE_YUVj
#endif
